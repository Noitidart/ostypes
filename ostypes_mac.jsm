...
var macInit = function() {
	...
	this.CONST = {
		...
		get kCFAllocatorSystemDefault () { if (!('kCFAllocatorSystemDefault' in _const)) { _const['kCFAllocatorSystemDefault'] = lib('CoreFoundation').declare('kCFAllocatorSystemDefault', self.TYPE.CFAllocatorRef); } return _const['kCFAllocatorDefault']; },
